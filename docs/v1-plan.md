...
| REQ-INSTALL-001 | Distribution    | Single-command install for full framework (BMAD + QUINT + BAQT) | Release | done    | installer/_, tests/test_installer_.py                                                                                                        |
...
- [x] Package full framework installer (BMAD + QUINT + BAQT)
