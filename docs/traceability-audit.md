...
| SPEC-011 | Tool execution pipeline (registry, gating, results) | missing | None                       | No tool execution pipeline         |
...
- Tool schema and risk metadata exist; safe file IO/repo tools, LSP adapter, validation runner, and tool execution pipeline spec added; enforcement and registry wiring remain pending.
