...
CHECK_PATHS = [
    ...
    ROOT / "docs" / "runtime-schemas.json",
    ROOT / "package.json",
    ROOT / "pytest.ini",
    ...
    ROOT / "runtime" / "schemas.py",
    ROOT / "runtime" / "prompts.py",
    ROOT / "runtime" / "storage.py",
    ROOT / "runtime" / "time_provider.py",
    ROOT / "runtime" / "guardrails" / "__init__.py",
    ROOT / "runtime" / "guardrails" / "checks.py",
    ROOT / "runtime" / "quint" / "__init__.py",
    ROOT / "runtime" / "quint" / "adi.py",
    ROOT / "runtime" / "quint" / "assurance.py",
    ROOT / "runtime" / "quint" / "decay.py",
    ROOT / "runtime" / "quint" / "drr.py",
    ROOT / "runtime" / "quint" / "store.py",
    ROOT / "runtime" / "providers" / "__init__.py",
    ROOT / "runtime" / "providers" / "base.py",
    ROOT / "runtime" / "providers" / "http.py",
    ROOT / "runtime" / "providers" / "reliability.py",
    ...
    ROOT / "tests" / "test_runtime_guardrails.py",
    ROOT / "tests" / "test_runtime_http.py",
    ROOT / "tests" / "test_runtime_models.py",
    ROOT / "tests" / "test_runtime_schemas.py",
    ROOT / "tests" / "test_time_tool.py",
    ROOT / "tests" / "test_runtime_plugins.py",
    ROOT / "tests" / "test_runtime_providers.py",
    ROOT / "tests" / "test_runtime_provider_reliability.py",
    ROOT / "tests" / "test_runtime_quint_adi.py",
    ROOT / "tests" / "test_runtime_quint_assurance.py",
    ROOT / "tests" / "test_runtime_quint_decay.py",
    ROOT / "tests" / "test_runtime_quint_drr.py",
    ROOT / "tests" / "test_runtime_quint_evidence.py",
